...
public class Cell extends JTextField {
   public static final Color BG_SHOWN = new Color(245, 236, 219); // cell bg
   public static final Color FG_SHOWN = new Color(104, 90, 83); // cell text
   public static final Color FG_NOT_SHOWN = new Color(104, 90, 83); //empty cell text
   public static final Color BG_NO_GUESS = new Color(250, 207, 150); //empty cell
   public static final Color BG_CORRECT_GUESS = new Color(187, 208, 186);  
   public static final Color BG_WRONG_GUESS = new Color(233, 181, 180);
